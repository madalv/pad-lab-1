...
from . import course_svc_pb2 as course__svc__pb2
...
class CourseServiceServicer(object):
    ...
    def GetCourseIdsForUser(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_CourseServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetCourseIdsForUser': grpc.unary_unary_rpc_method_handler(
                    servicer.GetCourseIdsForUser,
                    request_deserializer=course__svc__pb2.UserId.FromString,
                    response_serializer=course__svc__pb2.CourseIds.SerializeToString,
            ),
    }
...
class CourseService(object):
    ...
    @staticmethod
    def GetCourseIdsForUser(request,
            target,
            options=(),
